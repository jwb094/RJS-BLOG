...
import { notFound_seo } from "../data/page_seo";
function PageNotFound(props) {
  return (
    <>
      <MetaTags
        title={notFound_seo.seo.metaTitle}
        description={notFound_seo.seo.metaDescription}
        image={window.location.origin + notFound_seo.ogImage}
        name={notFound_seo.twitterName}
      />
      <section>
